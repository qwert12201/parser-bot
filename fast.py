...
def curses() -> dict[datetime: list[str]] | str:
    data = {
        "date": datetime.now().date(),
        "rate": [curse.kurs("https://www.banki.ru/products/currency/usd/"), curse.kurs("https://finance.rambler.ru/currencies/"), curse.kurs("https://www.kursvaliut.ru/")]
    }
    return data
